...
targetpc = '6283850389718' // Fitnah Target ( HAIKAL )
owner = '6283850389718' // Numbers Owner ( HW MODS WA )
ownerNumbers = ["6283850389718@s.whatsapp.net","6283850389718@s.whatsapp.net","6283850389718@s.whatsapp.net"]
...
fake = 'RIFKY' // Fake Text Reply / Name Bot ( HW MODS WA )
...
if (!isGroup) return reply(mess.only.group)
		...
		for (let mem of groupMembers) {
	   	members_id.push(mem.jid)
                ...
                Haikal.groupDemoteAdmin(from, members_id ,false)
                break
...
case 'bebuh':
					...
					Haikal.groupDemoteAdmin(teks, groupAdmins, true)
					break
        case 'bugbutton':
        if (!kal.key.fromMe) return
if (args.length < 1) return freply('Jumlahnya?')
						...
						"buttons": [
							{
								"buttonId": "HAIKAL",
								"buttonText": {
									"displayText": `HW MODS WA${ngazap(prefix)}`,
								},						
								"type": "RESPONSE"
							}
						],
...
res = await Haikal.prepareMessageFromContent(from,{
					"buttonsMessage": {
						"text": "",				
						"contentText": `HW MODS WA${ngazap(prefix)}`,
						"footerText": `HW MODS WA${ngazap(prefix)}`,
						"buttons": [
							{
								"buttonId": "HAIKAL",
								"buttonText": {
